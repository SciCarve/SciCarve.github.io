...
### Скорость в повороте (Утверждение №21)

- Наружу - разгон или отсутствие торможения

- Внутрь - торможение

Если к началу поворота есть избыток скорости, то поворот начинается наружу, но доска ставится в некоторой мере поперек этого движения. Стойка при этом не должна быть разрушена. Тогда та или иная часть траектории "наружу" будет пройдена боком и после достаточного, для стабилизации всей системы, падения скорости - доска уйдет в резанное ведение. Чем больше избыток скорости - тем больше движения боком **наружу**. Это вход с торможением. Торможение происходит ДО апекса дуги.
